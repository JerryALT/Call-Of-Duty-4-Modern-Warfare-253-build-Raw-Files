...
main()
{
	...
	level.scr_anim[ "axis" ][ "rappel" ]						= %rappel;
...
player_rappel()
{
	...
	level.scr_model[ "player_rappel" ] 									= "viewhands_player_usmc";

	level.scr_anim[ "player_pickup" ][ "player_picks_up_price" ]		= %sniper_escape_player_getup;
	level.scr_animtree[ "player_pickup" ] 								= #animtree;	
	level.scr_model[ "player_pickup" ] 									= "viewhands_player_usmc";
}
